...
MAX_LENGTH_SPECIALITY_NAME = 50
MIN_LENGTH_SPECIALITY_NAME = 2
LENGTH_SPECIALITY_NAME_ERROR_TEXT = (
    f"Длина поля от {MIN_LENGTH_SPECIALITY_NAME} до "
    f"{MAX_LENGTH_SPECIALITY_NAME} символов."
)
REGEX_SPECIALITY_NAME = r"(^[A-Za-zА-Яа-яЁё]+)\Z"
